    ...
    <div id="navbar">
        <div class="flex h-14 items-center justify-between px-4">
            ...
            <div class="hidden md:flex items-center justify-end gap-4">
                ...
                <el-select class="lang-select" size="small" :model-value="lang" :aria-label="dict.feat_lang_title"
                    @change="setLang">
                    <el-option label="English" value="en" />
                    <el-option label="မြန်မာ" value="my" />
                </el-select>
            </div>
...
.lang-select :deep(.el-select__wrapper:hover),
.lang-select :deep(.el-select__wrapper.is-focused) {
